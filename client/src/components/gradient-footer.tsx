export function GradientFooter() {
  return (
    <footer className="sticky bottom-0 z-40 w-full border-t-2 border-blue-500/50 dark:border-blue-400/50 bg-gradient-to-r from-blue-500/10 via-blue-600/10 to-blue-700/10 dark:from-blue-500/20 dark:via-blue-600/20 dark:to-blue-700/20 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 shadow-sm shadow-blue-500/20">>
